...
public class UserPreferences {
   ...
   * @param email
   */
  public UserPreferences(Integer id, String firstName, String lastName, String avatarName, Integer level, Integer coins, Integer battlesWon, Integer battlesLost, Integer battlesTied, Integer experiencePoints, Boolean available, Boolean online, Boolean gaming, String email, String avatarImage) {
    super();
    this.id = id;
